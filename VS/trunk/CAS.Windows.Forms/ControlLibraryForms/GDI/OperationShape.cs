...
//  $Id$
//  History :
//    20080707 - mzbrzezny: tooltip is added
  ...
  public class OperationShape: ShapeWithHotpointsAndLabel
  {
    ...
    protected override void RefreshPath()
    {
      lock ( this )
      {
        ...
        catch ( Exception ex )
        {
          ...
          TraceEvent.Tracer.TraceError( 61, sourceName,
    ...
    protected override void RecalculateAndCheckSizeOfTheShape()
    {
      ...
      catch ( Exception ex )
      {
        ...
        MessageBox.Show( String.Format( Resources.ErrorMessage, sourceName ), Resources.ErrorMessageCaption, MessageBoxButtons.OK, MessageBoxIcon.Error );
        TraceEvent.Tracer.TraceError( 118, sourceName,
          CAS.Lib.RTLib.Processes.TraceEvent.GetMessageWithExceptionNameFromExceptionIncludingInnerException( ex ) );
      }
    ...
    {
      if ( HotpointsInputs != null && HotpointsInputs.ContainsKey( HotpointType.Bottom ) && HotpointsInputs[ HotpointType.Bottom ] != null
        && HotpointsInputs[ HotpointType.Bottom ].Length > 0 )
      {
    ...
    {
      if ( HotpointsInputs != null && HotpointsInputs.ContainsKey( HotpointType.Top ) && HotpointsInputs[ HotpointType.Top ] != null
        && HotpointsInputs[ HotpointType.Top ].Length > 0 )
      {
        throw new NotImplementedException();
      }
      return null;
