//<summary>
//  Title   : Floaty, IFloaty - support for docking
...
namespace CAS.Lib.ControlLibrary.ControlExtenders
{
    ...
    public interface IFloaty
    {
        ...
        /// <summary>
        /// Gets a value indicating whether this <see cref="IFloaty"/> is visible.
        /// </summary>
    ...
    internal sealed class Floaty : Form, IFloaty
    {
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1060:MovePInvokesToNativeMethodsClass"), DllImport("User32.dll", EntryPoint = "SendMessage")]
        ...
        public new bool Visible
        {
          get
          {
            return ( base.Visible || this.DockState.Container.Visible );
          }
        }
        ...
        private void DockFloaty()
        {
            ...
            if (_dockState.OrgDockingParent is ToolStripContainer)
            {
              if (_dockState.Container is ToolStrip)
              {
                switch (_dockState.OrgDockStyle)
                {
                  case DockStyle.Right:
                    _dockState.Container.Parent = ((ToolStripContainer)_dockState.OrgDockingParent).RightToolStripPanel;
                    break;
                  case DockStyle.Left:
                    _dockState.Container.Parent = ((ToolStripContainer)_dockState.OrgDockingParent).LeftToolStripPanel;
                    break;
                  case DockStyle.Top:
                    _dockState.Container.Parent = ((ToolStripContainer)_dockState.OrgDockingParent).TopToolStripPanel;
                    break;
                  case DockStyle.Bottom:
                    _dockState.Container.Parent = ((ToolStripContainer)_dockState.OrgDockingParent).BottomToolStripPanel;
                    break;
                  default:
                    _dockState.Container.Parent = ((ToolStripContainer)_dockState.OrgDockingParent).ContentPanel;
                    break;
                }
              }
              else
            ...
            {
                if (_dockState.OrgDockingParent is ToolStripContainer)
                  _dockState.Splitter.Parent = ((ToolStripContainer)_dockState.OrgDockingParent).ContentPanel;
                else
