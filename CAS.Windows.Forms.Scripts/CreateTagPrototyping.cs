...
namespace CAS.Windows.Forms.Scripts
{
  ...
  public class CreateTagPrototyping
  {
    ...
    public void CreateTagTest()
    {
      ...
      string _solutionPath = @"/CAS.Windows.Forms";
      string _trunkPath = $@"{_repositoryUrl}trunk{_solutionPath}/";
      string _tagPath = $@"{_repositoryUrl}tags{_solutionPath}.rel_{_rel}";
      #endregion

      Assert.AreEqual("svn://svnserver.hq.cas.com.pl/VS/trunk/CAS.Windows.Forms/", _trunkPath);
      Assert.AreEqual("svn://svnserver.hq.cas.com.pl/VS/tags/CAS.Windows.Forms.rel_2_01_1061", _tagPath);
